...
<html lang="en">
  ...
  <body>
	...
	<?php
		...
		$query = "SELECT `id`,`firstname`,`lastname`,`email`,`phone`,`nationality`,`gender`,`age`,`quantity`,`package`,`shirtstyle`,`shirtsize`,`shirtcolor`,`ordertotal`,`orderstatus`,`paymenttype`,`paymentstatus`,`invoicenumber` FROM `orders` WHERE `package` = 'tshirtanddrinks' AND `discard` = 'N'";
	...
	<select onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
		...
		<option value="/Xquoticmas/tshirtndrinks.php" selected>T-Shirt and Drinks</option>
