...
<html lang="en">
  ...
  <body>
	...
	<?php
		...
		$query = "SELECT * FROM `orders` WHERE `package` = 'premiumcostume' AND `discard` = 'N'";
	...
	<select onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
		...
		<option value="/Xquoticmas/premiumcostume.php" selected>Premium Costume Package</option>
	</select>
	<br>
	<br>
	  <h2>Premium Costume Table</h2>
