	...
	<div class="row">
		...
		<div class="card">
			<div class="title-body"><h4 class="card-head">Drinks Only Package</h4></div>
	  		<img class="card-img-top" src="/Xquoticmas/assets/package/pic7.jpg" alt="Card image cap">
	  		<div class="card-body">
	    		<h5 class="card-title">Package Contents</h5>
				<li>Xquotic Mug</li>
				...
				<br>
	    		<hr>
	    		<button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#drinksModal" data-title="Drinks Only Package" data-picture="/Xquoticmas/assets/package/pic7.jpg" data-ordertotal="1000.00 JMD" >Register Now</button>
	  		</div>
		</div>
		<div class="card">
			<div class="title-body"><h4 class="card-head">T-Shirt &amp; Drinks Package</h4></div>
	  		<img class="card-img-top" src="/Xquoticmas/assets/package/pic5.jpg" alt="Card image cap">
	  		<div class="card-body">
	    		<h5 class="card-title">Package Contents</h5>
				<li>Xquotic Mug</li>
				<li>Premium Mixed Drinks</li>
				...
				<br>
	    		<hr>
	    		<button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#drinksModal" data-title="T-Shirt &amp; Drinks Package" data-picture="/Xquoticmas/assets/package/pic5.jpg" data-ordertotal="2500.00 JMD" >Register Now</button>
	  		</div>
		</div>
		<div class="card">
			<div class="title-body"><h4 class="card-head">Costume &amp; Drinks Package</h4></div>
	  		<img class="card-img-top" src="/Xquoticmas/assets/package/pic1.jpg" alt="Card image cap">
	  		<div class="card-body">
	    		<h5 class="card-title">Package Contents</h5>
				<li>Xquotic Mug</li>
				<li>Premium Mixed Drinks</li>
				...
				<br>
	    		<hr>
	    		<button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#drinksModal" data-title="Costume &amp; Drinks Package" data-picture="/Xquoticmas/assets/package/pic1.jpg" data-ordertotal="4000.00 - 6000.00 JMD" >Register Now</button>
	  		</div>
		</div>
		<div class="card">
			<div class="title-body"><h4 class="card-head">Basic T-Shirt Package</h4></div>
	  		<img class="card-img-top" src="/Xquoticmas/assets/package/pic6.jpg" alt="Card image cap">
	  		<div class="card-body">
	    		<h5 class="card-title">Package Contents</h5>
				...
				<br>
	    		<hr>
	    		<button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#drinksModal" data-title="Basic T-Shirt Package" data-picture="/Xquoticmas/assets/package/pic6.jpg" data-ordertotal="4000.00 JMD" >Register Now</button>
	  		</div>
		</div>
		<div class="card">
			<div class="title-body"><h4 class="card-head">Basic Costume Package</h4></div>
	  		<img class="card-img-top" src="/Xquoticmas/assets/package/pic2.jpg" alt="Card image cap">
	  		<div class="card-body">
	    		<h5 class="card-title">Package Contents</h5>
				<li>Xquotic Mason Jar</li>
				<li>Premium Mixed Drinks</li>
				...
				<br>
	    		<hr>
	    		<button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#drinksModal" data-title="Basic Costume Package" data-picture="/Xquoticmas/assets/package/pic2.jpg" data-ordertotal="6000.00 - 8000.00 JMD" >Register Now</button>
	  		</div>
		</div>
		<div class="card">
			<div class="title-body"><h4 class="card-head">Premium T-Shirt Package</h4></div>
	  		...
	  		<div class="card-body">
				...
				<hr>
	    		<button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#drinksModal" data-title="Premium T-Shirt Package" data-picture="/Xquoticmas/assets/package/pic4.jpg" data-ordertotal="6500.00 JMD" >Register Now</button>
	  		</div>
		</div>
		<div class="card">
      ...
      <div class="modal-body">
			...
			<div class="container my-container">
			  <form action="drinksonly.php" method="POST" enctype="multipart/form-data">
			    ...
			    <br>
				<input type="radio" id="paymenttype" name="paymenttype" value="facetoface"> Face to Face
				<hr>
			    <label for="inputState"></label>
			    <div class="form-group">
