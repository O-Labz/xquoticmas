<?php
  ...
  if (isset($_GET['edit'])) 
  {
    ...
    $query = "SELECT * FROM iqcc3 WHERE keyz = ".$id." ";
  ...
  if (isset($_POST['market'])) 
  {
    ...
    $sql = "UPDATE `iqcc3` SET`market`='$market',`switchemail`='$switchemail',`pcontact`='$pcontact',`pcnumber`='$pcnumber',`escalation`='$escalation',`escalnumber`='$escalnumber'WHERE keyz = ".$keyz."";
          ...
          <div id="myModal" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg ">
              ...
              <div class="modal-content">
                ...
                <div class="modal-header">
                      <form action="carrieredit3.php" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                            <label for="">Step 1) Insert Information:</label>
                            <br>
                          <label for="market" class="col-lg-3">Market:</label>
                          <input type="text" id="market" name="market" value="<?php echo $row['market']; ?>" required="">
                          <input type="hidden" id="keyz" name="keyz" value="<?php echo $row['keyz']; ?>">
                          <br>
                          <br>
                          <label for="switchemail" class="col-lg-3">Switching Email:</label>
                          <input type="text" id="switchemail" name="switchemail" value="<?php echo $row['switchemail']; ?>">
                          <br>
                          <br>
                          <label for="pcontact" class="col-lg-3">Primary Contact:</label>
                          <input type="text" id="pcontact" name="pcontact" value="<?php echo $row['pcontact']; ?>">
                          <br>
                          <br>
                          <label for="pcnumber" class="col-lg-3">Primary Number:</label>
                          <textarea class="form-control" rows="5" id="pcnumber" name="pcnumber"><?php echo $row['pcnumber']; ?></textarea> 
                          <br>
                          <br>
                          ...
                          <textarea class="form-control" rows="5" id="escalnumber" name="escalnumber"><?php echo $row['escalnumber']; ?></textarea> 
                          <br>
                          <br>                      
                        </div>
                        </div>        
                        <div class="modal-footer">
                          <button type="button" class="btn btn-default" onclick="location.href='http://172.27.27.192:1234/roamtechportal/iqc/iqccontacts3.php';" data-dismiss="modal">Cancel</button>
