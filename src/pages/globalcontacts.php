...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `contactsglobal` WHERE CONCAT (`country`, `operator`, `plmn`,`type`, `name`, `phone`,`email`) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}else 
{
    $query = "SELECT * FROM contactsglobal";
    $search_result = filterTable($query);
}
            ...
            <table class="table table-sm table-striped table-hover ">
                <thead class="thead-inverse">
                  <tr>
                    ...
                    <th class="bg-primary">Organisation Role</th>
                    <th class="bg-primary">Name of Personel</th>
