...
<html lang="en">
  ...
  <body>
	...
	<?php
		...
		$query = "SELECT * FROM `orders` WHERE `package` = 'costumeandrinks' AND `discard` = 'N'";
	...
	<select onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
		...
		<option value="/Xquoticmas/costumendrinks.php" selected>Costume and Drinks Orders</option>
